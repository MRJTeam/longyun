...
<body>
		...
		<div class="navbar-inner">
			<div class="container-fluid">
				<a class="btn btn-navbar" data-toggle="collapse"
					...
					class="icon-bar"></span>
				</a> <a class="brand" href="#"><span>龙云直播系统</span></a>
					...
					<ul class="nav pull-right">
						...
						<li class="dropdown hidden-phone"><a
							...
							<ul class="dropdown-menu messages">
								...
								<li><a href="#"> <span class="avatar"><img
											...
											<span class="from"> 龙云用户 </span> <span class="time"> 6
												min </span>
						...
						<li class="dropdown"><a class="btn dropdown-toggle"
							data-toggle="dropdown" href="#"> <i
								class="halflings-icon white user"></i> 龙云用户 <span class="caret"></span>
						</a>
							<ul class="dropdown-menu">
								<li class="dropdown-menu-title"><span>账户中心</span></li>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						<li><a href="main"><i class="icon-bar-chart"></i><span
								class="hidden-tablet"> 首页</span></a></li>
						<li><a href="main"><i class="icon-envelope"></i><span
								class="hidden-tablet"> 直播管理</span></a></li>
						<li><a href="main"><i class="icon-tasks"></i><span
								class="hidden-tablet"> 财务中心</span></a></li>
						<li><a href="main"><i class="icon-eye-open"></i><span
								class="hidden-tablet">数据统计</span></a></li>
						<li><a href="main"><i class="icon-dashboard"></i><span
								class="hidden-tablet"> 账户中心</span></a></li>
					</ul>
				</div>
			</div>
			<!-- end: Main Menu -->
	...
	<footer>
		...
		<p>
			<span style="text-align: left; float: left">&copy; 2016 <a
				...
				alt="Bootstrap_Metro_Dashboard">老米所有</a></span>
	...
	<script
		src="${pageContext.request.contextPath}/resources/js/jquery-migrate-1.0.0.min.js"></script>

	<script
		src="${pageContext.request.contextPath}/resources/js/jquery-ui-1.10.0.custom.min.js"></script>
	...
	<script
		src="${pageContext.request.contextPath}/resources/js/excanvas.js"></script>
	<script
		src="${pageContext.request.contextPath}/resources/js/jquery.flot.js"></script>
	<script
		src="${pageContext.request.contextPath}/resources/js/jquery.flot.pie.js"></script>
	<script
		src="${pageContext.request.contextPath}/resources/js/jquery.flot.stack.js"></script>
	<script
		src="${pageContext.request.contextPath}/resources/js/jquery.flot.resize.min.js"></script>

	<script
		src="${pageContext.request.contextPath}/resources/js/jquery.chosen.min.js"></script>

	<script
		src="${pageContext.request.contextPath}/resources/js/jquery.uniform.min.js"></script>

	<script
		src="${pageContext.request.contextPath}/resources/js/jquery.cleditor.min.js"></script>

	<script
		src="${pageContext.request.contextPath}/resources/js/jquery.noty.js"></script>

	<script
		src="${pageContext.request.contextPath}/resources/js/jquery.elfinder.min.js"></script>

	<script
		src="${pageContext.request.contextPath}/resources/js/jquery.raty.min.js"></script>

	<script
		src="${pageContext.request.contextPath}/resources/js/jquery.iphone.toggle.js"></script>

	<script
		src="${pageContext.request.contextPath}/resources/js/jquery.uploadify-3.1.min.js"></script>

	<script
		src="${pageContext.request.contextPath}/resources/js/jquery.gritter.min.js"></script>
	...
	<script
		src="${pageContext.request.contextPath}/resources/js/jquery.knob.modified.js"></script>
